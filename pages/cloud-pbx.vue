<template>
    <main>
        ...
        <section class="section bg-c-white pb-0 pt-[40px] xl:min-h-[685px] xl:bg-[url('/img/background.png')] xl:bg-cover">
            ...
            <img src="/img/hero.png" alt="" class="mx-auto w-full max-w-[640px] xl:hidden" />
        </section>
